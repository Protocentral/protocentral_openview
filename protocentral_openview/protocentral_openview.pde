...
/************** Packet Validation  **********************/
private
static final int CESState_Init = 0;
private
static final int CESState_SOF1_Found = 1;
private
static final int CESState_SOF2_Found = 2;
private
static final int CESState_PktLen_Found = 3;

/*CES CMD IF Packet Format*/
private
static final int CES_CMDIF_PKT_START_1 = 0x0A;
private
static final int CES_CMDIF_PKT_START_2 = 0xFA;
private
static final int CES_CMDIF_PKT_STOP = 0x0B;

/*CES CMD IF Packet Indices*/
private
static final int CES_CMDIF_IND_LEN = 2;
private
static final int CES_CMDIF_IND_LEN_MSB = 3;
private
static final int CES_CMDIF_IND_PKTTYPE = 4;
private
static int CES_CMDIF_PKT_OVERHEAD = 5;
...
int globalSamplingRate = 128;

int windowSize = 6 * globalSamplingRate; // Total Size of the buffer
...
boolean globalNotchFilterEnabled = true;
...
void makeGUI()
{
    ...
    Group g3 = cp5.addGroup("Filter Settings")
    ...
    case CESState_PktLen_Found:
        ...
        else // All data received
        {
            if (rxch == CES_CMDIF_PKT_STOP)
            {
                ...
                if (true == globalNotchFilterEnabled)
                {
                    try
                    {

                        // DataFilter.perform_bandpass(ch1Data,(int)globalSamplingRate,(double)3.0,(double)50.0, 4,(int) 1, 1.0);
                        DataFilter.perform_bandstop(ch1Data, globalSamplingRate, 48.0,
